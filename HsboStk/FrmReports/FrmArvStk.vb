...
Public Class FrmArvStk
    ...
    Private Sub TheSearch()
        ...
        If RdoLocal.Checked = True Or (RdoClient.Checked = True And LokClient.Text <> "") Then
            Dim lst = (From s In db.ArrivalTotal(TDate, FDate, Val(LokLoc.EditValue), Val(LokStore.EditValue), CalFlag(), clnt) Select s).ToList
            GridControl1.DataSource = lst
            FormatColumns()
        ElseIf RdoClient.Checked = True And LokClient.Text = ""
            Dim lst = (From s In db.ArvlTotalNoClnt(TDate, FDate, Val(LokLoc.EditValue), Val(LokStore.EditValue)) Select s).ToList
            GridControl1.DataSource = lst
            FormatColumnsAll()
        End If
    End Sub
    ...
    Private Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        If CanSearch() = True Then
            ...
            If RdoLocal.Checked = True Or (RdoClient.Checked = True And LokClient.Text <> "") Then
                ...
                If LokClient.Text <> "" Then
                    rpt.prmClntT.Value = "استلام من العميل: "
                ...
                rpt.prmClntT.Visible = False
                ''**************************
                rpt.RequestParameters = False
                rpt.ShowPreview()

            ElseIf RdoClient.Checked = True And LokClient.Text = ""
                Dim rpt As New RepArvNoClnt
    ...
    Private Sub RdoLocal_Click(sender As Object, e As EventArgs) Handles RdoLocal.Click
        ...
        'LokClient.Properties.Columns.Clear()
        'LokClient.Properties.NullText = ""
        LokClient.Text = ""
        LokClient.Enabled = False
    End Sub

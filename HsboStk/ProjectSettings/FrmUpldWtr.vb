...
Public Class FrmUpldWtr
    ...
    Private Sub BtnAssign_Click(sender As Object, e As EventArgs) Handles BtnAssign.Click
        ...
        While i < GVHead.RowCount
            MyRow = Val(GVHead.GetRowCellValue(i, "trkWtr"))
            tb = (From s In db.waterImgs Where s.trkWtr = Val(MyRow) Select s).SingleOrDefault
    ...
    Private Sub FrmUpldWtr_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Center(Me)
        FillGrid()
        FormatColumns()
    ...
    Private Sub SaveData()
        ...
        If MemAdd = True Then
            ...
            tb.imgExt = MyPic
            tb.actv = True
            db.waterImgs.InsertOnSubmit(tb)

            While i < GVHead.RowCount
                fRow = Val(GVHead.GetRowCellValue(i, "trkWtr"))
                tb = (From s In db.waterImgs Where s.trkWtr = Val(fRow) And s.actv = True Select s).SingleOrDefault
                If Not IsNothing(tb) Then
                    tb.actv = False
    ...
    Private Sub FillGrid()
        Dim i As Integer = 0
        Dim lst = (From s In db.waterImgs Select s).ToList
    ...
    Function NewKey() As Integer
        Dim max As Integer
        Dim Qrymax = (From trk In db.waterImgs Select trk.trkWtr).ToList
    ...
    Private Sub BtnDelete_Click(sender As Object, e As EventArgs) Handles BtnDelete.Click
        ...
        While i < GVHead.RowCount
            MyRow = Val(GVHead.GetRowCellValue(i, "trkWtr"))
            tb = (From s In db.waterImgs Where s.trkWtr = Val(MyRow) And s.actv = True Select s).SingleOrDefault
            If Not IsNothing(tb) Then
                If GVHead.IsRowSelected(i) Then
                    tb.actv = False
                    Pic.CutImage()
    ...
    Private Sub GVHead_RowCellClick(sender As Object, e As RowCellClickEventArgs) Handles GVHead.RowCellClick
        ...
        If e.Column.Caption = "عرض" Then
            MyRow = Val(GVHead.GetRowCellValue(e.RowHandle, "trkWtr"))
            tb = (From s In db.waterImgs Where s.trkWtr = Val(MyRow) Select s).SingleOrDefault
            If Not IsNothing(tb) Then
                Pic.Image = New Bitmap(tb.imgExt)
            End If

...
Public Class FrmGoodStk
    Private col1, col2, col3 As Columns.GridColumn
    Private FDate, TDate As DateTime

    Private Sub FrmGoodStk_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Center(Me)
        FillLoc()
    End Sub
    Private Sub FillLoc()
    ...
    Private Sub TheSearch()
        ...
        End If
        Dim lst = (From s In db.ExportTotal(TDate, FDate, Val(LokLoc.EditValue), Val(LokStore.EditValue)) Select s).ToList

...
Public Class FrmViewShpPrd
    ...
    Private Sub FillGrid()
        ...
        Select Case True
            Case Me.LokLoc.Text <> "" And LokStore.Text <> "" And LokExp.Text <> "" And FromDate.Text <> "" And ToDate.Text <> ""
                '00000
                Dim lst = (From s In db.V_expShips Where s.trkArival = Val(LokLoc.EditValue) _
                                                   ...
                                                   And s.trkAPrdStr <> 0
                           Select s.trkExpShip, s.arivalName, s.APrdStr, s.expName, s.expShipDate).ToList
            ...
            Case Me.LokLoc.Text = "" And LokStore.Text = "" And LokExp.Text = "" And FromDate.Text = "" And ToDate.Text = ""
                '11111
                Dim lst = (From s In db.V_expShips Where s.trkAPrdStr <> 0
                           Select s.trkExpShip, s.arivalName, s.APrdStr, s.expName, s.expShipDate).ToList
                GridControl1.DataSource = lst
    ...
    Private Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        ...
        Select Case True
            ...
            Case Me.LokLoc.Text <> "" And LokStore.Text <> "" And LokExp.Text <> "" And FromDate.Text <> "" And ToDate.Text <> ""
                rpt.TheFilter.Value = "مشحون من:  " & LokLoc.Text & "/ مخزن: " & LokStore.Text & " الى منطقة: " & LokExp.Text _
            ...
            '00011
            Case Me.LokLoc.Text <> "" And LokStore.Text <> "" And LokExp.Text <> "" And FromDate.Text = "" And ToDate.Text = ""
                rpt.TheFilter.Value = "مشحون من:  " & LokLoc.Text & "/ مخزن: " & LokStore.Text & " الى منطقة: " & LokExp.Text
                rpt.FilterString = "[trkArival]= " & Val(Me.LokLoc.EditValue) & " And [trkAPrdStr]= " & Val(LokStore.EditValue) _
                & " and [trkExpLoc]= " & Val(LokExp.EditValue)

            '00100
            Case Me.LokLoc.Text <> "" And LokStore.Text <> "" And LokExp.Text = "" And FromDate.Text <> "" And ToDate.Text <> ""
                rpt.TheFilter.Value = "مشحون من:  " & LokLoc.Text & "/ مخزن: " _
                    & "؛ " & " في الفترة بين: " & FDate.ToShortDateString & " و " & TDate.ToShortDateString
                rpt.FilterString = "[trkArival]= " & Val(Me.LokLoc.EditValue) & " And [trkAPrdStr]= " & Val(LokStore.EditValue) _
                    & " and [expShipDate] >= #" & FDate.ToShortDateString & "# and [expShipDate] <= #" & TDate.ToShortDateString & "#"
            '00101
            ...
            Case Me.LokLoc.Text <> "" And LokStore.Text <> "" And LokExp.Text = "" And FromDate.Text = "" And ToDate.Text = ""
                ...
                rpt.FilterString = "[trkArival]= " & Val(Me.LokLoc.EditValue) & " And [trkAPrdStr]= " & Val(LokStore.EditValue)
            ...
            '01010
            Case Me.LokLoc.Text <> "" And LokStore.Text = "" And LokExp.Text <> "" And FromDate.Text = "" And ToDate.Text <> ""
                rpt.TheFilter.Value = "مشحون من:  " & LokStore.Text & " الى منطقة: " & LokExp.Text _
                    & "؛ " & " الى تاريخ: " & TDate.ToShortDateString
                rpt.FilterString = "[trkArival]= " & Val(Me.LokLoc.EditValue) _
                & " and [trkExpLoc]= " & Val(LokExp.EditValue) _
            ...
            Case Me.LokLoc.Text <> "" And LokStore.Text = "" And LokExp.Text = "" And FromDate.Text <> "" And ToDate.Text <> ""
                rpt.TheFilter.Value = "مشحون من:  " & LokLoc.Text _
                    & "؛ " & " في الفترة بين: " & FDate.ToShortDateString & " و " & TDate.ToShortDateString
                rpt.FilterString = "[trkArival]= " & Val(Me.LokLoc.EditValue) _
                    & " and [expShipDate] >= #" & FDate.ToShortDateString & "# and [expShipDate] <= #" & TDate.ToShortDateString & "# And [trkAPrdStr] <> 0"
            '01101
            Case Me.LokLoc.Text <> "" And LokStore.Text = "" And LokExp.Text = "" And FromDate.Text <> "" And ToDate.Text = ""
                rpt.TheFilter.Value = "مشحون من:  " & LokLoc.Text _
                    & "؛ " & " من تاريخ: " & FDate.ToShortDateString
            ...
            Case Me.LokLoc.Text = "" And LokStore.Text = "" And LokExp.Text = "" And FromDate.Text <> "" And ToDate.Text <> ""
                ...
                rpt.FilterString = " [expShipDate] >= #" & FDate.ToShortDateString & "# and [expShipDate] <= #" & TDate.ToShortDateString & "# And [trkAPrdStr] <> 0"
